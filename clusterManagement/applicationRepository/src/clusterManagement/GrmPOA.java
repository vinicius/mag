	...
	implements org.omg.CORBA.portable.InvokeHandler, clusterManagement.GrmOperations
{
	...
	static
	{
		m_opsHash.put ( "registerGrm", new java.lang.Integer(0));
		m_opsHash.put ( "setKeepAliveInterval", new java.lang.Integer(1));
		m_opsHash.put ( "registerLrm", new java.lang.Integer(2));
		m_opsHash.put ( "requestRemoteExecution", new java.lang.Integer(3));
		m_opsHash.put ( "setSampleInterval", new java.lang.Integer(4));
		m_opsHash.put ( "isAvailable", new java.lang.Integer(5));
		m_opsHash.put ( "migrationLocationRequest", new java.lang.Integer(6));
		m_opsHash.put ( "updateLrmInformation", new java.lang.Integer(7));
		m_opsHash.put ( "setLocation", new java.lang.Integer(8));
		m_opsHash.put ( "updateGrmInformation", new java.lang.Integer(9));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // migrationLocationRequest
			{
				java.lang.String[] _arg0=dataTypes.FileNameSequenceHelper.read(_input);
				_out = handler.createReply();
				_out.write_string(migrationLocationRequest(_arg0));
				break;
			}
			case 7: // updateLrmInformation
			{
				java.lang.String _arg0=_input.read_string();
