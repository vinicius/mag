...
public class ExecutionRequest {
	...
	// Vinicius {
	public int numberOfRequestItens() {
		return requestItens.size();
	}
	// } Vinicius
	...
	// Vinicius {
	public boolean isNodeFinished(int asctSubRequestId) {
		return ((ExecutionRequestItem) requestItens.get(asctSubRequestId)).hasFinishedExecuting();
	}
	// } Vinicius
}
