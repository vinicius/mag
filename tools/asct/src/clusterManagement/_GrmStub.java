	...
	implements clusterManagement.Grm
{
	...
	public java.lang.String migrationLocationRequest(java.lang.String[] locations)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "migrationLocationRequest", true);
				dataTypes.FileNameSequenceHelper.write(_os,locations);
				_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "migrationLocationRequest", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			GrmOperations _localServant = (GrmOperations)_so.servant;
			java.lang.String _result;			try
			{
			_result = _localServant.migrationLocationRequest(locations);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void setLocation(java.lang.String location, java.lang.String ior)
	{
		...
		else
		{
			...
			try
			{
			_localServant.setLocation(location,ior);
			}
			finally
			{
				_servant_postinvoke(_so);
