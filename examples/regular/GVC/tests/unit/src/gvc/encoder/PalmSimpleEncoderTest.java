...
public class PalmSimpleEncoderTest {

	private static PalmSimpleEncoder encoder;
	private File inputFileMock;
	private File outputFileMock;
	//private File scriptFileMock;
	
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(PalmSimpleEncoderTest.class);
	}

	@BeforeClass public static void setUp() {
		encoder = new PalmSimpleEncoder();
	}
