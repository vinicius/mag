 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ReceiveRegisterAgentRequest extends AchieveREResponder {
	/**
	 * 
	 */
	...
	public ReceiveRegisterAgentRequest (ExecutionManagementAgentImpl ema, MessageTemplate mt) {
		super((Agent) ema, mt);
	...
	protected ACLMessage prepareResultNotification (ACLMessage request, ACLMessage response) throws FailureException {
		...
		try {
		    ...
		    executionManagementAgent.registerAgent(einfo);		    		
