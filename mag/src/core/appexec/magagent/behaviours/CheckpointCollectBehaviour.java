...
public class CheckpointCollectBehaviour extends SimpleBehaviour {
	...
	public void action() {
		...
		if (checkpoint == null) {
			...
			magAgent.addBehaviour (new SaveCheckpointBehaviour (magAgent, saveCheckpointMsg, magAgent.getAppExecutionId() + "." + magAgent.getApplication().getCheckpointCount(), checkpoint));
		}
	}
